...
* How to visualize dependencies using `tar_visnetwork()`
...
To instantiate our targets, we express the computation in a special configuration file called `_targets.R` which has to be at the project's root directory. 
